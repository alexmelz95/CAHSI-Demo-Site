...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    //Building the query
    $sql = "SELECT * FROM STUDENT WHERE Semail = '$myemail'";
    //Performs a query on the database
    $result = mysqli_query($db,$sql);
    //Fetch a result row as an associative, a numeric array, or both
    $row = mysqli_fetch_assoc($result);
    $hashedPwdCheck = password_verify($mypassword.$randString, $row['Spassword']);
...
<br>
                            ...
                            <a href="sregister.php" class="signup">Signup</a>
                        </div>
                    </div>
                </div>
            </div>
